...
training_window = 6  # consider the last 6 months of NO2 for each breast cancer diagnosis month

def create_xy_sequences(x_array, y_array, xy_steps=1):
    xy_sequence = []
    for i in range(len(x_array)):
        train_sequence = x_array[i*xy_steps:i*xy_steps+xy_steps]
